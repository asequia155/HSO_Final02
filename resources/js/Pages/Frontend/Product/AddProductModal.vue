        ...
        <form @submit.prevent="submit" class="p-4 md:p-5">
          <div class="grid gap-4 mb-4 grid-cols-1 sm:grid-cols-2">
            ...
            <div class="col-span-2 sm:col-span-1">
              ...
              <input v-model.number="product.quantity" id="quantity" type="number" min="0" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required />
            </div>
          </div>
...
// Computed property to check if price is valid
...
const resetForm = () => {
  product.value = { name: '', price: null, category_id: null, description: '', quantity: null }; // Reset all fields
};
