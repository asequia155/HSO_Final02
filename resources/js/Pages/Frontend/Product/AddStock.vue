        ...
        <form @submit.prevent="submit">
          <div class="grid gap-4 mb-4">
            ...
            <div class="flex items-center space-x-4">
             ...
             <!-- Batch Number -->
             <div class="flex items-center space-x-4">
              <label for="batch_number" class="text-sm font-medium text-gray-900 dark:text-white w-1/3">Batch No:</label>
              <input v-model="batchNumber" id="batch_number" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-2/3 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter batch number" />
            </div>

            <!-- Expiration Control -->
            <div class="flex items-center space-x-4">
              <label class="text-sm font-medium text-gray-900 dark:text-white w-1/3">Expiration:</label>
            ...
            <div v-if="hasExpiration === 'true'" class="flex items-center space-x-4">
              <label for="production_date" class="text-sm font-medium text-gray-900 dark:text-white w-1/3">Production:</label>
            ...
            <!-- Expiry Date -->
            <div v-if="hasExpiration === 'true'" class="flex items-center space-x-4">
              <label for="expiry_date" class="text-sm font-medium text-gray-900 dark:text-white w-1/3">Expiry:</label>
...
// Store additional batch details
