<template>
    <div v-if="isOpen" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75" style="z-index: 1000;">
      <div class="relative w-full max-w-3xl p-6 bg-white rounded shadow-md">
        <button
          @click="close"
        ...
        <h2 class="mb-4 text-xl font-semibold">Add Patient</h2>
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <input
                ...
                id="first_name"
                type="text"
                class="w-full p-2 capitalize border rounded"
            ...
            <div>
              ...
              <select v-model="gender" id="gender" class="w-full p-2 border rounded">
            ...
            <div>
              ...
              <div class="flex items-center">
                <span class="p-2 bg-gray-200 border rounded-l">+63</span>
                <input
                  v-model="phone"
                  id="phone"
                  type="text"
            ...
            <div>
              ...
              <input
                ...
                class="w-full p-2 border rounded"
              />
              <p v-if="errors.date_of_birth" class="mt-1 text-sm text-red-500">{{ errors.date_of_birth }}</p>
            </div>
  ...
  if (newValue) {
    gender.value = newValue.toLowerCase(); // Normalize to lowercase
  }
});
