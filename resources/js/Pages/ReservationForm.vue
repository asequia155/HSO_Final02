<template>
    <div class="container p-6 mx-auto">
        <div class="p-8 bg-white rounded-lg shadow-md">
              ...
              <!-- Mobile Version -->
    <div class="flex justify-center hidden mb-6 back-mobile md:block">
        <a
            href="/"
            class="inline-block px-4 py-2 mb-10 font-medium text-white bg-red-500 rounded-md shadow hover:bg-red-600"
        >
            Back Home
        </a>
    </div>
          <!-- Desktop Version -->
    <div class="hidden mb-6 back-desktop md:block">
        <a
            href="/"
...
import Modal from './Frontend/Reservation/Modal.vue';
...
const validateForm = () => {
    ...
    if (!form.occupation) errors.value.occupation = "Occupation is required.";
